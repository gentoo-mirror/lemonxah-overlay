...
if [[ ${PV} == *9999 ]]; then
	...
	SRC_URI="https://github.com/falkTX/Carla/archive/refs/tags/v2.5.3.tar.gz -> ${P}.tar.gz"
#	SRC_URI="https://github.com/falkTX/Carla/archive/refs/tags/v${PV}.tar.gz -> ${P}.tar.gz"
	RESTRICT="mirror"
	KEYWORDS="~amd64"
	S="${WORKDIR}/Carla-${PV}"
fi
